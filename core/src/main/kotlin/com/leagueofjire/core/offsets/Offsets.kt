...
object Offsets {
	...
	const val MissileSpellInfo = 0x278L//0x8L //12.1
	const val MissileSrcIdx = 0x2DCL//0x6CL //12.1
	const val MissileDestIdx = 0x310L//0xC0L //12.1
	const val MissileStartPos = 0x2F4L//0x90L //12.1
	const val MissileEndPos = 0x300L//0x9CL //12.1

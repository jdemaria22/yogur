...
interface Targeting {
    ...
    fun getBestTargetForRangeMonster(monster: ObjectList<IGameUnit>, localPlayer: IGameUnit, range: Float): Optional<IGameUnit>

    fun getBestTargetForRangeMinion(minions: ObjectList<IGameUnit>, localPlayer: IGameUnit, range: Float): Optional<IGameUnit>
